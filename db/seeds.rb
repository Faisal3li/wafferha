...
Offer.create(offer_Description: "25% discount on all sizes of Cinnapacks from Cinnabon for SAR 5 only. Valid at over 100 branches across KSA",
              start_Date: "2/3/2018", expired_Date: "5/3/2018", image: "app/assets/images/cinnabon.jpg", coLocation: "",
              view_Count: "", coupon: "", premium: true, used: false, company_id: com1.id )
Offer.create(offer_Description: "buy one get one free ", expired_Date: "2018-11-28 14:23:21", start_Date: "2018-11-28 14:23:21", image: "http://fillmurray.com/200/200", coLocation: "Riyadh", view_Count: 2, coupon: "RA01", premium: false, used: false, category_id: 130, company_id: com2.id)
